...
import AdminEditRequestsPage from '../AdminEditRequestsPage/AdminEditRequestsPage';
      ...
      <Router>
        <div>
          <Switch>
            ...
            />
            <ProtectedRoute exact path="/admin/edit_requests/:id"
              component={AdminEditRequestsPage}
            />
